...
Usage:
    python manage.py seed_data          # Create all dummy data
...
from apps.sites.models import DeviceInstallation, Site, SiteZone
...
class Command(BaseCommand):
    help = "Seed database with comprehensive test data for all roles and entities"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"    Deactivated:   deactivated  / {PASSWORD}")
        self.stdout.write("")
    ...
    def _create_clients(self):
        ...
        client_data = [
            {
                "name": "Dubai Mall Group",
                "code": "CLT-001",
                "contact_person": "Mohammed Al Maktoum",
                "contact_email": "info@dubaimall.ae",
                "contact_phone": "+97142345678",
            ...
            },
            {
                ...
                "contact_email": "ops@adairports.ae",
                "contact_phone": "+97126789012",
                "address": "Abu Dhabi International Airport, Abu Dhabi, UAE",
            },
            {
                "name": "Saudi Aramco Retail",
                "code": "CLT-003",
                "contact_person": "Abdullah Al Saud",
                "contact_email": "retail@aramco.sa",
                "contact_phone": "+966512345678",
                "address": "Dhahran, Eastern Province, Saudi Arabia",
            },
            {
                "name": "Qatar Energy Solutions",
                "code": "CLT-004",
                "contact_person": "Khalid Al Thani",
                "contact_email": "tech@qatarenergy.qa",
                "contact_phone": "+97444556677",
            ...
            },
            {
                ...
                "contact_email": "facilities@emaar.ae",
                "contact_phone": "+97143678900",
                "address": "Burj Khalifa Blvd, Downtown Dubai, UAE",
                "is_active": False,
            },
        ]
    ...
    def _create_suppliers(self):
        ...
        supplier_data = [
            {
                "name": "Samsung Display MENA",
                "code": "SUP-001",
                "contact_person": "Kim Yong",
                "contact_email": "b2b@samsung-mena.com",
                "contact_phone": "+97141112233",
            ...
            },
            {
                ...
                "code": "SUP-002",
                "contact_person": "Park Jun",
                "contact_email": "enterprise@lg-gulf.com",
                "contact_phone": "+97142223344",
                "address": "Dubai Silicon Oasis, Dubai, UAE",
                "website": "https://lg.com",
            },
            {
                "name": "NEC Display Solutions",
                "code": "SUP-003",
                "contact_person": "Tanaka Hiroshi",
                "contact_email": "sales@nec-display.ae",
                "contact_phone": "+97143334455",
                "address": "DAFZA, Dubai, UAE",
                "website": "https://nec-display.com",
            },
            {
                "name": "BrightSign Middle East",
                "code": "SUP-004",
                "contact_person": "Tom Richards",
                "contact_email": "orders@brightsign.me",
                "contact_phone": "+97144445566",
                "address": "Internet City, Dubai, UAE",
                "website": "https://brightsign.biz",
            },
        ]
    ...
    def _create_sites(self, clients):
        ...
        site_data = [
            ...
            },
            {
                ...
                "city": "Dubai",
                "country": "UAE",
                "latitude": Decimal("25.1975000"),
                "longitude": Decimal("55.2750000"),
                "contact_person": "Mall Operations",
                "contact_phone": "+97141001002",
                "operating_hours": "10:00-23:00",
                "client": clients[0],
            },
            {
                "name": "Abu Dhabi Airport - Terminal 1",
                "address": "Abu Dhabi International Airport",
                "city": "Abu Dhabi",
                "country": "UAE",
                "latitude": Decimal("24.4330000"),
                "longitude": Decimal("54.6511000"),
                "contact_person": "Airport IT",
                "contact_phone": "+97126001001",
                "operating_hours": "24/7",
                "client": clients[1],
            },
            {
                "name": "Aramco HQ Lobby",
                "address": "Dhahran, Eastern Province",
                "city": "Dhahran",
                "country": "Saudi Arabia",
                "latitude": Decimal("26.2743000"),
                "longitude": Decimal("50.1536000"),
                "contact_person": "Aramco Facilities",
                "contact_phone": "+966138001001",
                "operating_hours": "07:00-18:00",
                "client": clients[2],
            },
            {
                "name": "Doha Tower - Reception",
                "address": "West Bay, Doha",
                "city": "Doha",
                "country": "Qatar",
                "latitude": Decimal("25.3194000"),
                "longitude": Decimal("51.5310000"),
                "contact_person": "Building Management",
                "contact_phone": "+97444001001",
                "operating_hours": "08:00-20:00",
                "client": clients[3],
            },
            {
                "name": "Emaar Square Kiosk",
                "address": "Burj Khalifa Blvd, Downtown Dubai",
                "city": "Dubai",
                "country": "UAE",
                "latitude": Decimal("25.1990000"),
                "longitude": Decimal("55.2760000"),
                "client": clients[4],
                "is_active": False,
            },
        ]
    ...
    def _create_zones(self, sites):
        zones = []
        zone_data = {
            0: [("Entrance A", "Main glass entrance", "Ground"),
                ("Entrance B", "Side entrance near parking", "Ground"),
                ("Info Desk", "Central info desk area", "Ground")],
            1: [("Zone A - Asian", "Asian food court section", "2nd Floor"),
                ("Zone B - Western", "Western food court section", "2nd Floor")],
            2: [("Arrivals Hall", "Main arrivals hall", "Ground"),
                ("Departures Lounge", "After security", "1st Floor"),
                ("Check-in Area", "Check-in counters", "Ground")],
            3: [("Main Lobby", "Reception area", "Ground"),
                ("Conference Floor", "Meeting rooms", "3rd Floor")],
            4: [("Reception", "Main reception area", "Ground")],
        }

        for site_idx, zone_list in zone_data.items():
            if site_idx >= len(sites):
                continue
            for name, description, floor in zone_list:
                ...
                if created:
                    self.stdout.write(f"  Created zone: {sites[site_idx].name} > {name}")
                zones.append(zone)
        ...
        for i in range(30):
            ...
            device, created = Device.objects.get_or_create(
                ...
                defaults={
                    ...
                    "invoice_reference": f"INV-{2026}-{i+1:04d}",
                    "batch_number": f"BATCH-{(i // 5) + 1:03d}",
            ...
            if created:
                self.stdout.write(f"  Created device: {device.asset_code} ({stat})")
    ...
    def _create_lifecycle_events(self, devices, users):
        ...
        if device.status in (Device.Status.ACTIVE, Device.Status.INSTALLED):
            DeviceLifecycleEvent.objects.create(
                device=device,
                event_type=DeviceLifecycleEvent.EventType.LOCATION_CHANGE,
                to_value=device.current_site.name if device.current_site else "N/A",
    ...
    def _create_tickets(self, devices, sites, users):
        ...
        ticket_data = [
            ("Display black screen at entrance", "Screen is powered on but shows no image", "high", "open", "repair"),
            ("Install new kiosk at food court", "Customer requested new 55\" kiosk installation", "medium", "in_progress", "installation"),
            ("Screen flickering at Terminal 1", "Intermittent flickering reported by airport staff", "critical", "open", "repair"),
            ("Replace damaged display", "Physical damage from forklift impact", "high", "on_hold", "replacement"),
            ("Annual inspection – Dubai Mall", "Scheduled annual device audit for all displays", "low", "in_progress", "inspection"),
            ("Relocate 3 screens to new wing", "Mall expansion requires device relocation", "medium", "open", "relocation"),
            ("Media player firmware update", "BrightSign units need firmware v4.2 update", "low", "resolved", "other"),
            ("HDMI port failure – lobby screen", "HDMI port not detecting media player signal", "high", "open", "repair"),
            ("New installation – Doha Tower", "4 screens for reception area", "medium", "in_progress", "installation"),
            ("Overheating alert – outdoor unit", "Temperature sensor triggered on outdoor screen", "critical", "open", "repair"),
            ("Warranty claim – Samsung panel", "Dead pixels on 3-month old panel", "medium", "resolved", "replacement"),
            ("Scheduled display cleaning", "Quarterly cleaning for all Dubai Mall screens", "low", "closed", "inspection"),
        ]
    ...
    def _create_warranties(self, devices, suppliers):
        ...
        for i, device in enumerate(active_devices[:12]):
            ...
            warranty, created = Warranty.objects.get_or_create(
                ...
                defaults={
                    ...
                    "start_date": start,
                    "end_date": end,
                    "coverage_details": f"Covers hardware defects and panel replacement for {(end - start).days // 365} year(s).",
                    "reference_number": f"WRN-{2026}-{i+1:04d}",
                },
            )
            if created:
                self.stdout.write(f"  Created warranty: {device.asset_code} ({warranty.warranty_type})")
    ...
    def _create_maintenance(self, devices, sites, users):
        ...
        schedule_data = [
            ...
            ("Predictive Analytics Sensor Check", "predictive", "quarterly"),
            ...
            if freq != "one_time":
                for j in range(random.randint(1, 3)):
                    rec = MaintenanceRecord.objects.create(
                        ...
                        notes=f"Maintenance #{j+1} completed as per schedule.",
    ...
    def _create_inventory(self, material_types, sites, users):
        ...
        for i, mt in enumerate(material_types):
            item, created = InventoryItem.objects.get_or_create(
                sku=f"INV-{mt.category[:3].upper()}-{i+1:04d}",
                defaults={
                    "material_type": mt,
                    "quantity": random.randint(2, 100),
                    "min_stock_level": random.randint(3, 10),
                    "location": "warehouse" if i < 5 else "site",
                    "site": active_sites[i % len(active_sites)] if i >= 5 and active_sites else None,
                    "unit_cost": Decimal(str(random.randint(5, 200))),
                    "notes": f"Standard inventory item for {mt.name}",
                },
            )
            if created:
            ...
            for j in range(random.randint(1, 3)):
                mv = StockMovement.objects.create(
                    ...
                    reference=f"MV-{2026}-{i*3+j+1:04d}",
    ...
    def _create_procurement(self, suppliers, users):
        ...
        po_data = [
            ("PO-2026-0001", "ordered", 10),
            ("PO-2026-0002", "received", -30),
            ("PO-2026-0003", "draft", 0),
            ("PO-2026-0004", "pending_approval", 5),
            ("PO-2026-0005", "approved", 7),
            ("PO-2026-0006", "partially_received", -10),
            ("PO-2026-0007", "cancelled", -60),
        ]
        ...
        for i, (po_num, status, day_offset) in enumerate(po_data):
            ...
            if created:
                ...
                po.save()
                self.stdout.write(f"  Created PO: {po_num} ({status}) — {total}")
            pos.append(po)
    ...
    def _create_finance(self, clients, suppliers, pos, users):
        ...
        inv_data = [
            ("INV-R-2026-001", "receivable", "paid", 0),
            ("INV-R-2026-002", "receivable", "sent", 15),
            ("INV-R-2026-003", "receivable", "overdue", -20),
            ("INV-R-2026-004", "receivable", "draft", 30),
            ("INV-P-2026-001", "payable", "paid", -5),
            ("INV-P-2026-002", "payable", "sent", 10),
            ("INV-P-2026-003", "payable", "partially_paid", 5),
            ("INV-P-2026-004", "payable", "overdue", -15),
        ]

        for i, (inv_num, inv_type, status, day_offset) in enumerate(inv_data):
            amount = Decimal(str(random.randint(2000, 50000)))
